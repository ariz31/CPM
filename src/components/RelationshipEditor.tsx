    ...
    <section className="surface panel-stack" aria-labelledby="logic-title">
      ...
      <form
        ...
        onSubmit={(event) => {
          ...
          onAdd({ id: crypto.randomUUID(), predecessorId, successorId, type, lag });
        }}
      >
        ...
        <label>Lag (days)<input type="number" step={0.25} value={lag} onChange={(event) => setLag(Number(event.target.value))} /></label>
