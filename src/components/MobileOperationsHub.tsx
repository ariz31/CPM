      ...
      <div className="mobile-operations-shell">
        ...
        <div className="mobile-operations-content">
          ...
          {view === 'activity' ? <section aria-labelledby="mobile-activity-title">
            ...
            <label className="mobile-field">Activity<select value={activityId} onChange={(event) => setActivityId(event.target.value)}><option value="">Choose an activity…</option>{filteredActivities.map((activity) => <option key={activity.id} value={activity.id}>{activity.id} — {activity.name}</option>)}</select></label>
          ...
          {view === 'progress' ? <section aria-labelledby="mobile-progress-title">
            ...
            <label className="mobile-field">Activity<select value={progressActivityId} onChange={(event) => setProgressActivityId(event.target.value)}><option value="">Choose an activity…</option>{taskActivities.map((activity) => <option key={activity.id} value={activity.id}>{activity.id} — {activity.name}</option>)}</select></label>
