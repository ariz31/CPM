    ...
    <div className="controls-stack">
      <section className="surface">
        ...
        {!analysis ? <p className="notice">A valid schedule calculation is required.</p> : <>
          ...
          <ScurveChart curves={analysis.curves} currency={project.metadata.currency} />
      ...
      <div className="workspace-grid">
        <DataViewFrame title="Activity phasing" eyebrow="Budget distribution" description="Focus the table for detailed review and editing.">
        ...
        <DataViewFrame title="Actual costs" eyebrow="Cost ledger" description="Record and review actual cost entries.">
      ...
      <DataViewFrame title="Billing, retention, recovery, and tax" eyebrow="Contract cash flow" description="Focus the cash-flow configuration and recent periods.">
